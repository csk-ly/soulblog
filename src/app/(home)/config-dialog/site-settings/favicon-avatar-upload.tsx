	...
	return (
		<div className='grid grid-cols-2 gap-4'>
			<div>
				...
				<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-lg border bg-white/8'>
					{faviconItem?.type === 'file' ? (
						<img src={faviconItem.previewUrl} alt='favicon preview' className='h-full w-full object-cover' />
					) : (
						<img src='/favicon.ico' alt='current favicon' className='h-full w-full object-cover' />
					)}
			...
			<div>
				...
				<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-full border bg-white/8'>
