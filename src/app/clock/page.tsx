						...
						<div className='flex items-center justify-center gap-4'>
							<div className='flex flex-col items-center gap-2'>
								...
								<input
									...
									className='no-spinner w-20 rounded-xl border bg-white/8 px-4 py-3 text-center text-2xl font-bold backdrop-blur-sm focus:bg-white/12'
								/>
							</div>
				...
				<div className='flex items-center justify-center gap-4'>
					{mode === 'stopwatch' && (
						<motion.button
							...
							onClick={handleLap}
							disabled={!isRunning}
							className='flex h-16 w-16 items-center justify-center rounded-full border bg-white/8 text-sm font-medium backdrop-blur-sm transition-all hover:bg-white/12 disabled:cursor-not-allowed disabled:opacity-50'>
							计次
						</motion.button>
					)}
					<motion.button
					...
					<motion.button
						...
						className='flex h-16 w-16 items-center justify-center rounded-full border bg-white/8 backdrop-blur-sm transition-all hover:bg-white/12 disabled:cursor-not-allowed disabled:opacity-50'>
