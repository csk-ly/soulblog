				...
				<div className='mb-4 flex items-center gap-4'>
					<div className='group relative cursor-pointer' onClick={() => setShowImageDialog(true)}>
						{formData.image ? (
							...
							<div className='flex h-16 w-16 items-center justify-center rounded-xl bg-white/6'>
					...
					<div className='flex-1'>
						...
						<div className='mt-1 flex items-center gap-2'>
							<input
								...
								placeholder='年份'
								className='text-secondary w-20 rounded border border-white/20 px-2 py-1 text-xs focus:outline-none'
							/>
							<input
								type='url'
								value={formData.url}
